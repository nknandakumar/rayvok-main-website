            ...
            {faqs.map((faq, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <span className="text-[#1A1A1A] font-display font-medium text-[20px] md:text-[24px] leading-[36px] pr-8 group-hover:text-black transition-colors duration-300 leading-snug">
                      {faq.q}
                    </span>
                    ...
                    <div 
                      className={`w-10 h-10 rounded-full border flex items-center justify-center shrink-0 transition-all duration-300 ${
                        isOpen 
                          ? "bg-[#C9FE34] border-[#BDEB19] text-[#0E0E0E]" 
                          : "border-[#EAE7DF] text-[#5A5A50] group-hover:border-black group-hover:text-black"
                      }`}
                    >
                      <svg 
                  ...
                  <AnimatePresence initial={false}>
                    {isOpen && (
                      ...
                      >
                        <p className="text-[#5C5C57] text-[15px] leading-relaxed pb-6 max-w-2xl">
                          {faq.a}
                        </p>
                      </motion.div>
                    )}
